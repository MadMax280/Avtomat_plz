# Серверная часть "Поликлиника"
<img src="https://c.tenor.com/D2G7Qqkrr78AAAAC/jojos-bizarre-adventures-caesar.gif" align="right" />
...
### Information
> Здесь находятся папки с докерфайлами для образа сервера, образ базы данных подтягивается с внешнего SQL-сервера.

> В файле .env находятся системные переменные, такие как порты, название образов, которые мы инжектируем в наш docker-compose файл.

> В файле docker-compose.yml мы описываем инструкцию для развёртывания образа сервера.
